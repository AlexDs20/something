...
const char* sv_as_cstr(struct Arena* arena, StringView sv);
...
// STRING
//==============================
String  string_init_empty(struct Arena* arena, size_t capacity);
String  string_init_fmt(struct Arena* arena, const char* fmt, ...);
String  string_init_vfmt(struct Arena* arena, const char* fmt, va_list args);
String  string_init_sv(struct Arena* arena, StringView sv);
...
int     string_append_fmt(struct Arena* arena, String* str, const char* fmt, ...);
int     string_append_vfmt(struct Arena* arena, String* str, const char* fmt, va_list args);
int     string_append_sv(struct Arena* arena, String* str, StringView append);
...
static inline int string_append_char(struct Arena* arena, String* str, char c) { return string_append_sv(arena, str, sv_from_buffer(&c, 1)); }

int     string_prepend_fmt(struct Arena* arena, String* str, const char* fmt, ...);
int     string_prepend_vfmt(struct Arena* arena, String* str, const char* fmt, va_list args);
int     string_prepend_sv(struct Arena* arena, String* str, StringView pre);
...
static inline int string_prepend_char(struct Arena* arena, String* str, char c) { return string_prepend_sv(arena, str, sv_from_buffer(&c, 1)); }

int     string_insert_fmt(struct Arena* arena, String* str, size_t pos, const char* fmt, ...);
int     string_insert_vfmt(struct Arena* arena, String* str, size_t pos, const char* fmt, va_list args);
int     string_insert_sv(struct Arena* arena, String* str, size_t pos, StringView ins);
...
static inline int string_insert_char(struct Arena* arena, String* str, size_t pos, char c) { return string_insert_sv(arena, str, pos, sv_from_buffer(&c, 1)); }

int     string_overwrite_fmt(struct Arena* arena, String* str, size_t pos, const char* fmt, ...);
int     string_overwrite_vfmt(struct Arena* arena, String* str, size_t pos, const char* fmt, va_list args);
int     string_overwrite_sv(struct Arena* arena, String* str, size_t pos, StringView sv);
...
static inline int string_overwrite_char(struct Arena* arena, String* str, size_t pos, char c) { return string_overwrite_sv(arena, str, pos, sv_from_buffer(&c, 1)); }

int     string_erase_and_insert_fmt(struct Arena* arena, String* str, size_t pos, size_t len, const char* fmt, ...);
int     string_erase_and_insert_vfmt(struct Arena* arena, String* str, size_t pos, size_t len, const char* fmt, va_list args);
int     string_erase_and_insert_sv(struct Arena* arena, String* str, size_t pos, size_t len, StringView sv);
...
static inline int string_erase_and_insert_char(struct Arena* arena, String* str, size_t pos, size_t rm_len, char c) { return string_erase_and_insert_sv(arena, str, pos, rm_len, sv_from_buffer(&c, 1)); }

int string_replace_first(struct Arena* arena, String* string, StringView target, StringView replacement);
int string_replace_last(struct Arena* arena, String* string, StringView target, StringView replacement);
int string_replace_all(struct Arena* arena, String* str, StringView target, StringView replacement);

int     string_clear(String* str);
int     string_erase(String* str, size_t pos, size_t len);
String  string_deep_copy(struct Arena* arena, String str);
int     string_reserve(struct Arena* arena, String* str, size_t new_capacity);
#define string_increase_capacity(arena, str, amount)  string_reserve((arena), (str), (str) ? (str)->size + (amount) : 0)
int     string_shrink_to_fit(struct Arena* arena, String* str);
